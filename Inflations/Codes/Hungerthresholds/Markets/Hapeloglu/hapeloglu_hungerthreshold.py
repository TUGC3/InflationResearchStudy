...
FILES = {
    "Feb 2026": f"{BASE_DIR}/hapeloglu_2026-02-28.csv",
    "Mar 2026": f"{BASE_DIR}/hapeloglu_2026-03-31.csv",
    "Apr 2026": f"{BASE_DIR}/hapeloglu_2026-04-30.csv",
    "May 2026": f"{BASE_DIR}/hapeloglu_2026-05-31.csv",
}
...
MATCH_RULES = {
    ...
    "Chicken": {
        ...
        "exclude": ["Döner", "Nugget", "Şinitzel", "Sarma", "Köfte", "Kroket", "Çıtır",
                    ...
                    "Oyuncak", "Hipp", "Suyu", "Mr", "Burcu", "Mister", "Köri", "Teriyaki"],
        "unit": "kg",
    },
    "Fish": {
    ...
    "Banana": {
        ...
        "exclude": ["Cipsi", "Kurutulmuş", "Çikolata", "Süt", "Puding", "Gofret",
                    ...
                    "Sakız", "Pasta", "Dankek", "Eker", "Sütaş", "İçim", "Rondo","Eyüp","Çıtır","Algida"],
        "unit": "kg",
    },
    "Seasonal Fruit": {
        ...
        "exclude": [
            ...
            "Pınar", "Salam", "Sucuk", "Köfte", "Füme", "Sosis",
            ...
            "Muz", "File", "Püre", "Pekmez", "Kraker", "Merhem", "Organik", "Krem", "Ozmo","Eti","Orsev","Domestos","Torku","Parex","Çınar","Bonisa","Çiçek","Çiçeği","Zeytin","First","Islak","Kokulu",
            "Özü","Yayla","Kent","Perwoll","Meze","Su","Sap","Uludağ","Turşu","Kuş","Ezici","Koleston","Diş","Kız","Cappy","Köme"
        ],
        "unit": "kg",
    },
    "Onion": {
        ...
        "exclude": ["Taze", "Pırasa", "Toz", "Pul", "Sarımsak", "Halkası", "Cips",
                    ...
                    "Nutzz", "Çizi", "Baharat", "Cipsi", "Eti Crax","Tadım"],
        "unit": "kg",
    },
    "Eggplant / Zucchini": {
...
def is_sold_by_kg(name: str) -> bool:
    """True if product name ends with Kg/kg without a preceding number.
    e.g. 'Soğan Kg', 'Hamsi Kg', 'Dana Kuşbaşı Kg'
    """
    return bool(re.search(r'\s[Kk][Gg]\.?\s*$', str(name).strip()))
